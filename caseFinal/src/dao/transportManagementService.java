...
public interface transportManagementService {
	...
	void deleteVehicle(Scanner get) throws FileNotFoundException, IOException, SQLException;
	...
	void scheduleTrip(int vehicleId, int routeId, String departure, String arrival);
	...
	void deallocateDriver(Scanner sc);
	boolean allocateDriver(Scanner sc);
