...
public class modules {
    ...
    public void simulateVehicleNotFound(String vehicleId) throws VehicleNotFoundException {
        if (!vehicles.containsKey(vehicleId)) {
            throw new VehicleNotFoundException("Vehicle with ID " + vehicleId + " not found.");
        }
    }

    public void simulateBookingNotFound(int bookingId) throws BookingNotFoundException {
